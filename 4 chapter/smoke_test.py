...
print('Cart name info is correct')
...
print('Cart price info is correct')
...
delivery_price_product_1 = driver.find_element(By.XPATH, '//div[@class="inventory_item_price"]')
...
total_item = 'Item total: ' + delivery_value_price_product_1
print(str(total_item))
assert value_total_price == total_item
